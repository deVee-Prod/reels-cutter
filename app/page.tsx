...
export default function ReelsCutterPage() {
 ...
 {/* ── Bottom panel — CUT MODE only ──
  Gated on zoomMode alone. It used to wait for segments as well, so choosing a
  file left the controls absent until the analysis returned; now it appears with
  the video and fills in when the segments arrive. Its place in the tree is
  unchanged — moving it out of this branch is what broke playback before. */}
 {!zoomMode && (
 <div className="flex flex-col bg-[#0c0c0c] border border-white/[0.03] rounded-[24px] p-4 md:p-6 shadow-inner gap-4 md:gap-6 w-full mb-6">
 {/* ── CUTTER MODE ── */}
